<template>
  <div>
    <h1 class="mb-4 text-2xl font-bold text-primary">Privacy Policy</h1>
    <hr class="w-full border-gray-800" />
    <div class="my-5 text-justify text-black-100">
      <span class="text-red-50">Strategy First Education Group Ltd.</span> built the SFIx app as a
      Commercial app. This SERVICE is provided by Strategy First Education Group and is intended for
      use as is. This page is used to inform visitors regarding our policies with the collection,
      use, and disclosure of Personal Information if anyone decided to use our Service.If you choose
      to use our Service, then you agree to the collection and use of information in relation to
      ...
      and Conditions, which is accessible at SFIx unless otherwise defined in this Privacy Policy.
    </div>
    <h5 class="mb-2 text-lg font-semibold text-black-100">Information Collection and Use</h5>
    <div class="text-justify text-black-100 mb-7">
      For a better experience, while using our Service, we may require you to provide us with
      certain personally identifiable information, including but not limited to User's Phone Number,
      Email, Name. The information that we request will be retained by us and used as described in
      this privacy policy. The app does use third party services that may collect information used
      to identify you.
    </div>

    <h5 class="mb-2 text-lg font-semibold text-black-100">Log Data</h5>
    <div class="text-justify text-black-100 mb-7">
    ...
    <h5 class="mb-2 text-lg font-semibold text-black-100">Cookies</h5>
    <div class="text-justify text-black-100 mb-7">
    ...
    <h5 class="mb-2 text-lg font-semibold text-black-100">Service Providers</h5>
    <div class="text-justify text-black-100 mb-7">
      We may employ third-party companies and individuals due to the following reasons:
      <ul class="mx-3 my-3">
        <li class="list-disc">To facilitate our Service;</li>
        <li class="list-disc">To provide the Service on our behalf;</li>
        <li class="list-disc">To perform Service-related services; or</li>
        <li class="list-disc">To assist us in analyzing how our Service is used.</li>
      </ul>
    ...
    <h5 class="mb-2 text-lg font-semibold text-black-100">Security</h5>
    <div class="text-justify text-black-100 mb-7">
    ...
    <h5 class="mb-2 text-lg font-semibold text-black-100">Links to Other Sites</h5>
    <div class="text-justify text-black-100 mb-7">
    ...
    <h5 class="mb-2 text-lg font-semibold text-black-100">Children’s Privacy</h5>
    <div class="text-justify text-black-100 mb-7">
    ...
    <h5 class="mb-2 text-lg font-semibold text-black-100">Changes to This Privacy Policy</h5>
    <div class="text-justify text-black-100 mb-7">
      We may update our Privacy Policy from time to time. Thus, you are advised to review this page
      periodically for any changes. We will notify you of any changes by posting the new Privacy
      Policy on this page.This policy is effective as of 2020-07-14.
    </div>

    <h5 class="mb-2 text-lg font-semibold text-black-100">Contact Us</h5>
    <div class="text-justify text-black-100 mb-7">
      If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact
      us at No. 9A, Baho Road, San Chaung Township, Yangon, Myanmar.
    </div>
  </div>
</template>
